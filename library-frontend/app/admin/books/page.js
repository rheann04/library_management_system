...
export default function BooksPage() {
  ...
  const books = [
    ...
    { id: 6, title: 'The Catcher in the Rye', author: 'J.D. Salinger', isbn: '978-0316769488', status: 'Available', publishedYear: '1951', publisher: 'Little, Brown and Company', copies: 1, description: 'A coming-of-age story.' },
    { id: 7, title: 'Lord of the Flies', author: 'William Golding', isbn: '978-0399501487', status: 'Available', publishedYear: '1954', publisher: 'Faber and Faber', copies: 2, description: 'A novel about civilization and savagery.' },
    { id: 8, title: 'Animal Farm', author: 'George Orwell', isbn: '978-0452284241', status: 'Borrowed', publishedYear: '1945', publisher: 'Secker and Warburg', copies: 3, description: 'An allegorical novella.' },
    { id: 9, title: 'The Grapes of Wrath', author: 'John Steinbeck', isbn: '978-0143039433', status: 'Available', publishedYear: '1939', publisher: 'The Viking Press', copies: 2, description: 'An American realist novel.' },
